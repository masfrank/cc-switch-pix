...
pub async fn get_claude_plugin_status(
    ...
    crate::claude_plugin::claude_config_status_for_db(state.db.as_ref())
...
#[tauri::command]
pub async fn read_claude_plugin_config(
    state: tauri::State<'_, crate::store::AppState>,
) -> Result<Option<String>, String> {
    crate::claude_plugin::read_claude_config_for_db(state.db.as_ref()).map_err(|e| e.to_string())
}
...
pub async fn apply_claude_plugin_config(
    ...
    if official {
        crate::claude_plugin::clear_claude_config_for_db(state.db.as_ref())
            .map_err(|e| e.to_string())
    } else {
...
#[tauri::command]
pub async fn is_claude_plugin_applied(
    state: tauri::State<'_, crate::store::AppState>,
) -> Result<bool, String> {
