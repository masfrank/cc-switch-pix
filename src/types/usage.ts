 ...
 * `opencode` / `zcode` usage comes from their local session databases.
 * `openclaw` / `hermes` have no usage importer or proxy handler yet.
 */
export type AppType = "claude" | "codex" | "gemini" | "opencode" | "zcode";
